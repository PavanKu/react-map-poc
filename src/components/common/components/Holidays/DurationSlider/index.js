  ...
  afterChange(){
	...
	render() {
        ...
        <div className="filtersOuter mapSlider">
            <p className="rangeSection font14"> <span className="latoBold">DURATION: </span>: (<span className="min_price">{this.state.dynamicRangee[0]} </span>Days - <span className="max_price">{this.state.dynamicRangee[1]}</span>Days) </p>
